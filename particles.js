	...
	this.pJS = {
		...
		particles: {
			...
			line_linked: {
				...
				distance: 100,
				color_index: 0,
				color_list: ["#012534", "#612534", "#512533", "#512537", "#515534"],
				color: "#012534",
				opacity: 1,
				width: 1,
			},
	...
	pJS.fn.vendors.eventsListeners = function () {
		...
		if (pJS.interactivity.events.onclick.enable) {
			pJS.interactivity.el.addEventListener("click", function () {
				...
				// #1
				pJS.particles.line_linked.color = pJS.particles.line_linked.color_list[pJS.particles.line_linked.color_index];
				pJS.particles.line_linked.color_index = (pJS.particles.line_linked.color_index + 1) % 5;
				pJS.canvas.ctx.strokeStyle =
					"rgba(" +
					pJS.particles.line_linked.color_rgb_line.r +
					"," +
					pJS.particles.line_linked.color_rgb_line.g +
					"," +
					pJS.particles.line_linked.color_rgb_line.b +
					")";
